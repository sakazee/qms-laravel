...
<div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    <a href="{{ route('animals.index') }}" class="card group p-5 transition-shadow hover:shadow-lift">
        ...
        <div class="mt-4 font-serif text-[26px] font-bold text-gray-900">{{ $stats['total_animals'] ?? 0 }}</div>
    ...
    <a href="{{ route('partners.index') }}" class="card group p-5 transition-shadow hover:shadow-lift">
        ...
        <div class="mt-4 font-serif text-[26px] font-bold text-gray-900">{{ $stats['total_partners'] ?? 0 }}</div>
