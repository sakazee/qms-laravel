...
{{-- Animals Table --}}
<div class="card mt-6">
    <div class="card-header"><h3 class="card-title"><i class="fa-solid fa-horse text-emerald-700"></i>{{ __('animals.animals') }}</h3></div>
...
<div class="card mt-6">
    <div class="card-header"><h3 class="card-title"><i class="fa-solid fa-file-invoice-dollar text-amber-700"></i>{{ __('expenses.expenses') }}</h3></div>
    <div class="table-wrap">
        <table class="w-full text-[13px]">
            <thead class="border-b border-gray-200 bg-paper-100">
                <tr>
