<div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
    ...
    <div>
        ...
        @error('email')<p class="mt-1 text-[12px] font-medium text-rose-600">{{ $message }}</p>@enderror
    </div>
    ...
    <div>
        ...
        @error('phone')<p class="mt-1 text-[12px] font-medium text-rose-600">{{ $message }}</p>@enderror
    </div>
    ...
    <div class="sm:col-span-2">
        ...
        @error('role')<p class="mt-1 text-[12px] font-medium text-rose-600">{{ $message }}</p>@enderror
    </div>
    ...
    <div>
        ...
        @error('locale')<p class="mt-1 text-[12px] font-medium text-rose-600">{{ $message }}</p>@enderror
    </div>
</div>