@extends('layouts.app')
@section('title', __('expense_heads.create'))
@section('page-title', __('expense_heads.create'))
@section('breadcrumb')
    <span><a href="{{ route('expense-heads.index') }}" class="hover:text-emerald-700">{{ __('expense_heads.expense_heads') }}</a></span>
    <i class="fa-solid fa-chevron-right text-[10px] text-gray-400"></i>
    <span class="text-gray-600">{{ __('expense_heads.create') }}</span>
@endsection
...
<div class="mx-auto max-w-2xl">
    <div class="card">
        <div class="card-header bg-emerald-800">
            <h3 class="card-title text-white"><i class="fa-solid fa-plus"></i>{{ __('expense_heads.create') }}</h3>
        </div>
        <div class="card-body">
